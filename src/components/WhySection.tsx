...
const reasons = [
  { num: '01', title: 'Intelligence Before Personnel', desc: 'Every engagement begins with a threat assessment and security architecture document — not a headcount. We protect you before guards arrive.' },
  { num: '02', title: 'Forensic-Grade Leadership', desc: 'Our director holds dual forensic diplomas from the University of Lagos. Your security is led by someone who understands evidence, not just crowd control.' },
  { num: '03', title: 'ZumaGrid Accountability', desc: "Nigeria's first ZumaGrid operator. Every guard deployment runs on biometric verification and immutable digital records — court-admissible and NDPR compliant." },
  { num: '04', title: 'Proven at the Highest Level', desc: 'NFL Africa. FIFA. Davido. IShowSpeed. Kai Cenat. These are not pilot engagements — they are the benchmark. We bring that same standard to every client.' },
]
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(1.25rem,5vw,3.5rem)' }}>
        <ScrollReveal>
          <div style={{ maxWidth: 640, margin: '0 auto', textAlign: 'center', marginBottom: '4rem' }}>
            <span className="eyebrow">Why Olswen</span>
            <h2 style={{ fontFamily: 'var(--font-space-grotesk)', fontSize: 'clamp(1.8rem,3.5vw,2.6rem)', fontWeight: 700, letterSpacing: '-0.02em', lineHeight: 1.15, color: '#0c0a18' }}>The Standard Others Measure Against</h2>
          </div>
        </ScrollReveal>
